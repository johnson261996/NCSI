...
class EventUpcoming_ListAdapter(context: Context, rowItems: ArrayList<UpcomingEvent_Data>):BaseAdapter() {

    var context: Context = context
    var rowItems : ArrayList<UpcomingEvent_Data> = rowItems
    private val arraylist: ArrayList<UpcomingEvent_Data> = ArrayList<UpcomingEvent_Data>()
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        convertView = mInflator.inflate(R.layout.eventupcoming_listitems, null)
        holder = ViewHolder()
        ...
        holder.txtinterested.setText((rowItems.get(position).interestedStatus))
    ...
    override fun getItem(position: Int): UpcomingEvent_Data {
